...
<c:set var="commUpd" value="${ForwardConst.CMD_CLI_UPDATE.getValue()}" />
<c:set var="commDel" value="${ForwardConst.CMD_CLI_DESTROY.getValue()}" />
...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
        ...
        <p>
            <a href="#" onclick="confirmDestroy();">この取引先情報を削除する</a>
        </p>
        <form method="POST"
